...
namespace Alaa\HeadFooterScripts\Ui\DataProvider\Form;
 ...
 * @package Alaa\HeadFooterScripts\Ui\DataProvider\Form
...
class ScriptDataProvider extends AbstractDataProvider
{
    ...
    public function getData()
    {
        ...
        $data = $this->dataPersistor->get('head_footer_scripts');
        if (!empty($data)) {
            $page = $this->collection->getNewEmptyItem();
            $page->setData($data);
            $this->loadedData[$page->getId()] = $page->getData();
            $this->dataPersistor->clear('head_footer_scripts');
        }
